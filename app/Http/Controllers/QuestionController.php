...
class QuestionController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('questions.index', $data->lessonId)->with('toast_success', 'Create data succeed!');
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        switch ($request->action) {
            ...
            default:
                return redirect()->route('questions.index', $data->lessonId)->with('toast_success', 'Update data succeed!');
                break;
        }
    }
    ...
    public function jsontable(Request $request)
    {
        ...
        $data = Question::when($keyword, function ($query, $keyword) {
            ...
            ->orderBy($sort, $dir)
            ->get();
        $recordsTotal = Question::select('id')->count();
